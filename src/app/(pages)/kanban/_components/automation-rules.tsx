...
import { Column, Rule } from "../../../../../types/kanban";
    ...
    <div className="space-y-4 flex flex-col ">
          ...
          <DialogContent className="dark:bg-gray-800 dark:border-gray-700">
            <DialogHeader>
              ...
              <DialogDescription className="dark:text-gray-400">
                Crie uma regra para mover tarefas automaticamente com base em condições.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 py-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Mover tarefas atrasadas..."
              ...
              <div className="space-y-2">
                <Label className="dark:text-gray-300">Quando (Condição)</Label>
                <Select
                ...
                >
                  ...
                  <SelectContent className="dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <SelectItem value="subtasks-completed">Subtarefas</SelectItem>
                    <SelectItem value="custom-field">Campo Personalizado</SelectItem>
                  </SelectContent>
                </Select>
                ...
                {newRule.condition.type === "due-date" && (
                  ...
                  >
                    ...
                    <SelectContent className="dark:bg-gray-800 dark:border-gray-700">
                      <SelectItem value="is-overdue">Está Atrasado</SelectItem>
                    </SelectContent>
                  </Select>
                )}
                  ...
                  <>
                    ...
                    >
                      ...
                      <SelectContent className="dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <SelectItem value="not-equals">Diferente</SelectItem>
              ...
              <div className="space-y-2">
                <Label className="dark:text-gray-300">Então (Ação)</Label>
                <Select
      ...
      {rules.length === 0 ? (
        <div className="text-center py-8 text-gray-500 dark:text-gray-400">
          <p>Sem regras de automação ainda. Crie uma para automatizar seu fluxo de trabalho.</p>
        </div>
      ) : (
        <div className="space-y-2">
          {rules.map((rule) => (
